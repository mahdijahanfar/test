    ...
    var vc3dEye = function (selectorName, params) {
        ...
        function loadAppropriateImage(newX) {
            ...
            if (currentX - newX > 25) {
                ...
                selector.css("background-image", "url(" + imagePath + "sg10-360_" + currentImage + "." + imageExtension + ")");
        ...
        function forceLoadAllImages() {
            ...
            var loadedImages = 2;
            var appropriateImageUrl = imagePath + "sg10-360_" + "1." + imageExtension;
            ...
            for (var n = 2; n <= totalImages; n++) {
                appropriateImageUrl = imagePath + "sg10-360_" + n + "." + imageExtension;
